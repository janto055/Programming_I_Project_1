...
public class Payment {
    ...
    public double paymentValue(){
        double total = (numberOfOneDollarBills * DOLLARVALUE) + (numberOfQuarters * QUATERVALUE) + (numberOfDimes * DIMEVALUE) + (numberOfNickels * NICKELVALUE) + (numberOfPennies * PENNYVALUE);
